		...
		public IActionResult Index()
		{
			var viewModel = new IndexViewModel()
			{
				...
				CollectionModel = new CollectionModel
				{
					...
					{
						new CollectionItemModel { Id = "1", Title = "Apple watch", Price = 649.00m, ImageUrl = "images/placeholders/270x295.svg" },
						new CollectionItemModel { Id = "2", Title = "Samsung phone", Price = 699.00m, ImageUrl = "images/placeholders/270x295.svg" },
						new CollectionItemModel { Id = "3", Title = "Dell PC", Price = 299.00m, ImageUrl = "images/placeholders/270x295.svg" },
						new CollectionItemModel { Id = "4", Title = "Dyson vacuumcleaner", Price = 199.00m, ImageUrl = "images/placeholders/270x295.svg" },
